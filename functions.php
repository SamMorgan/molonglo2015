...
function enqueue_scripts_styles() {
    ...
    wp_enqueue_script( 'js', get_template_directory_uri() . "/js/min/js-min.js", array('jquery','jquery-ui-draggable'), filemtime( get_stylesheet_directory() . '/js/min/js-min.js' ), true );
